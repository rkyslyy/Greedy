...
- (void)createDarkMask {
    CGRect darkMaskFrame = CGRectMake(0, 0, self.view.frame.size.width,
                                      self.view.frame.size.height - (self.view.frame.size.height - self.expenseNameView.frame.origin.y));
    ...
    [UIView animateWithDuration:0.2f animations:^{
        ...
        UITapGestureRecognizer * tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(endEditingExpenseName)];
