...
- (void)showCategoriesCollection {
    ...
    self.categoriesCollection = [[UICollectionView alloc] initWithFrame:collectionFrame collectionViewLayout:[[UICollectionViewFlowLayout alloc] init]];
    ...
    [self.categoriesCollection registerNib:[UINib nibWithNibName:@"CategoryCollectionCellXIB" bundle:nil] forCellWithReuseIdentifier:@"categoryCollectionCell"];
...
- (void)paintDetailsViewWithColor:(UIColor *)color {
    ...
    [self.titleTextField setAttributedPlaceholder:[self getPlaceholderPaintedWith:color andMessage:@"Expense name"]];
    ...
    [self.costTextField setAttributedPlaceholder:[self getPlaceholderPaintedWith:color andMessage:@"0 UAH"]];
