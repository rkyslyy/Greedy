...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView
  ...
  cell.colorCircle.backgroundColor = [[ColorsManager getAllColors] objectAtIndex:category.colorIndex];
  [cell.icon setImage:[IconsManager getIconForIndex:indexPath.item]];
