...
+ (NSArray<Category *> *)getAllNonZeroCategories {
  ...
  NSArray *nonZeroCategories = [[self getAllCategories] filteredArrayUsingPredicate:predicate];
...
+ (NSArray<Category *> *)getMonthNonZeroCategories {
  ...
  NSArray *nonZeroCategories = [[self getAllCategories] filteredArrayUsingPredicate:predicate];
  return [nonZeroCategories sortedArrayUsingComparator:^NSComparisonResult(id  _Nonnull obj1,
                                                                           id  _Nonnull obj2) {
    float total1 = [ExpensesManager getTotalCostOf:obj1];
    float total2 = [ExpensesManager getTotalCostOf:obj2];
    return total1 < total2;
